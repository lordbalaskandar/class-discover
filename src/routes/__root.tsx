...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pulsatract — Book pilates, boxing, pickleball and more" },
      { name: "description", content: "Discover and book the best local fitness classes. From pilates to pickleball, find your next session on Pulsatract." },
      { property: "og:title", content: "Pulsatract — Book pilates, boxing, pickleball and more" },
      { property: "og:description", content: "Discover and book the best local fitness classes. From pilates to pickleball, find your next session on Pulsatract." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Pulsatract — Book pilates, boxing, pickleball and more" },
      { name: "twitter:description", content: "Discover and book the best local fitness classes. From pilates to pickleball, find your next session on Pulsatract." },
